...
//  Project5
//
//  Created by Uzay Altıner on 23.01.2022.
//
        ...
        if isPossible(word: lowerAnswer) {
            if isOriginal(word: lowerAnswer) {
                if isReal(word: lowerAnswer) {
                    ...
                    showErrorMessage("Word not recognized", "You can't just make them up, and you know it!")
                }
            } else {
                showErrorMessage("Word already used", "Be an original")
            }
        } else {
